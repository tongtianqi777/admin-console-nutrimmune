...
<link href="${pageContext.request.contextPath}/resources/css/theme.blue.css" rel="stylesheet" >
<link href="${pageContext.request.contextPath}/resources/css/basics.css" rel="stylesheet" >
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery.tablesorter.widgets.min.js"></script>